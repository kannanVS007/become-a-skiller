            ...
            <Card className="h-full flex flex-col p-4 overflow-hidden relative border-white/10 dark:border-white/5 bg-white/40 dark:bg-gray-800/40 backdrop-blur-md">
                ...
                <div className="relative h-48 mb-4 rounded-2xl overflow-hidden">
                    ...
                    <div className="absolute inset-0 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                        <button className="px-6 py-2 bg-white/20 backdrop-blur-md border border-white/30 text-white rounded-full font-semibold text-sm hover:bg-white/40 transition-all transform translate-y-4 group-hover:translate-y-0 duration-300">
                            View Details
                        </button>
                    </div>
                </div>
                ...
                <div className="flex-1 flex flex-col">
                    ...
                    <div className="mt-auto pt-4 border-t border-gray-100 dark:border-white/5 flex items-center justify-between">
                        ...
                        <motion.button
                            ...
                            className="p-3 bg-gradient-primary text-white rounded-xl shadow-glow hover:shadow-glow-lg transition-all"
                        >
